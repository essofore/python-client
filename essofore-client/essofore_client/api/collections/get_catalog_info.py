...
) -> Optional[Union[BadRequest, CatalogInfo, UnprocessableContent]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[BadRequest, CatalogInfo, UnprocessableContent]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[BadRequest, CatalogInfo, UnprocessableContent]
    """

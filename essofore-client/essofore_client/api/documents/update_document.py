...
from ...models.update_document_metadata import UpdateDocumentMetadata
...
def _get_kwargs(
    ...
    *,
    ...
    doc_type: Union[Unset, DocumentType] = UNSET,
    source_url: Union[Unset, str] = UNSET,
    metadata: Union[Unset, "UpdateDocumentMetadata"] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        doc_type (Union[Unset, DocumentType]):
        source_url (Union[Unset, str]):
        metadata (Union[Unset, UpdateDocumentMetadata]):

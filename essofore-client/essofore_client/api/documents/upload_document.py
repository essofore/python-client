...
from ...models.upload_document_metadata import UploadDocumentMetadata
...
def _get_kwargs(
    *,
    ...
    metadata: Union[Unset, "UploadDocumentMetadata"] = UNSET,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        metadata (Union[Unset, UploadDocumentMetadata]):
        body (File):
